---
title: "11 - Processus stochastiques (partie 2)"
author: "Jérôme Soucy"
---

## Question 1

Construisez une procédurequi prend comme entrée un vecteur $\vec{v}$, et qui retourne un vecteur de probabilités colinéaire à $\vec{v}$. Vous pouvez prendre pour acquis que le vecteur donné en entrée admet un vecteur de probabilités qui lui est colinéaire.
...
- (A) les automobiles (berlines et coupés) ;
- (V) les véhicules utilitaires sportifs ;
- (C) les camionnettes.
...
![Schéma des intersections](Policier/policier.pdf)
