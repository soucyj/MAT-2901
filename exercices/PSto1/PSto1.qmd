---
title: "10 - Processus stochastiques (partie 1)"
author: "Jérôme Soucy"
---
...
1. $\mattrois{6}{14}{9}{0}{3}{0}{0}{-10}{-3}$
...
- $\lambda_1$: $(t, 0, 0)$ où $t \in \mathbb{R}$.
- $\lambda_2$: $(t, 0, -t)$ où $t \in \mathbb{R}$.
- $\lambda_3$: $(t, 3t, -5t)$ où $t \in \mathbb{R}$.
:::

2. $\mattrois{1}{2}{3}{3}{2}{1}{4}{4}{4}$
...
- $\lambda_1$: $(5t, 4t, 9t)$ où $t \in \mathbb{R}$.
- $\lambda_2$: $(t, -t, 0)$ où $t \in \mathbb{R}$.
- $\lambda_3$: $(t, -2t, t)$ où $t \in \mathbb{R}$.
:::

3. $\matdeux{a}{0}{0}{b}$ où $a, b \in \mathbb{R}$
...
### Cas 2: $a = b \neq 0$
La matrice est une multiple scalaire de l'identité, donc tout vecteur non nul est un vecteur propre.

### Cas 3: $a \neq b$
Les valeurs propres sont $\lambda_1 = a$ et $\lambda_2 = b$. Les vecteurs propres associés sont :
- $\lambda_1$: $(t, 0)$ où $t \in \mathbb{R}$.
- $\lambda_2$: $(0, t)$ où $t \in \mathbb{R}$.
:::

4. $\mattrois{1}{0}{\frac{1}{3}}{0}{\frac{1}{2}}{\frac{1}{3}}{0}{\frac{1}{2}}{\frac{1}{3}}$
...
- $\lambda_1$: $(t, 0, 0)$ où $t \in \mathbb{R}$.
- $\lambda_2$: $(-2t, t, t)$ où $t \in \mathbb{R}$.
- $\lambda_3$: $(t, 2t, -3t)$ où $t \in \mathbb{R}$.
:::
...
\[
A = \matdeux{1}{\frac{1}{2}}{0}{2}, \quad \text{où } A \cdot \vdeux{1}{0} = \vdeux{1}{0}.
\]
Le vecteur $(1, 0)$ est un vecteur propre de $A$ associé à la valeur propre 1, mais $A$ n'est pas stochastique.
:::
